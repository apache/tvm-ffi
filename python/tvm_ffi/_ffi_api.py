...
if TYPE_CHECKING:
    ...
    def ArrayEqual(_0: Sequence[Any], _1: Any, /) -> bool: ...
    def ArrayGetItem(_0: Sequence[Any], _1: int, /) -> Any: ...
    def ArrayHash(_0: Sequence[Any], /) -> int: ...
    ...
    def MapEqual(_0: Mapping[Any, Any], _1: Any, /) -> bool: ...
    def MapHash(_0: Mapping[Any, Any], /) -> int: ...
