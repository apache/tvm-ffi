...
if TYPE_CHECKING:
    ...
    def DictClear(_0: Mapping[Any, Any], /) -> None: ...
    def DictCount(_0: Mapping[Any, Any], _1: Any, /) -> int: ...
    def DictErase(_0: Mapping[Any, Any], _1: Any, /) -> None: ...
    def DictForwardIterFunctor(_0: Mapping[Any, Any], /) -> Callable[..., Any]: ...
    def DictGetItem(_0: Mapping[Any, Any], _1: Any, /) -> Any: ...
    def DictGetItemOrMissing(_0: Mapping[Any, Any], _1: Any, /) -> Any: ...
    def DictSetItem(_0: Mapping[Any, Any], _1: Any, _2: Any, /) -> None: ...
    def DictSize(_0: Mapping[Any, Any], /) -> int: ...
