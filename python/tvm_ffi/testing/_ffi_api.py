...
if TYPE_CHECKING:
    ...
    def schema_id_dict_str_int(_0: Mapping[str, int], /) -> MutableMapping[str, int]: ...
    def schema_id_dict_str_str(_0: Mapping[str, str], /) -> MutableMapping[str, str]: ...
    ...
    def schema_id_list_int(_0: Sequence[int], /) -> MutableSequence[int]: ...
    def schema_id_list_obj(_0: Sequence[Object], /) -> MutableSequence[Object]: ...
    def schema_id_list_str(_0: Sequence[str], /) -> MutableSequence[str]: ...
