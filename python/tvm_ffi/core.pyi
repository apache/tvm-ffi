...
def _install_field_helpers(cls: type, type_info: TypeInfo) -> None: ...
def _install_field_getattro(cls: type, type_info: TypeInfo) -> None: ...
def _make_field_property(type_field: TypeField) -> property: ...
