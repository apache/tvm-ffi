...
class AccessPathObj : public Object {
 public:
   ...
   */
  inline AccessPath Extend(const AccessStep& step) const;
...
class AccessPath : public ObjectRef {
 ...
 private:
  ...
  explicit AccessPath(const ObjectPtr<AccessPathObj>& ptr) : ObjectRef(ptr) {}
};
...
inline AccessPath AccessPathObj::Extend(const AccessStep& step) const {
