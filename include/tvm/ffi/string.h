...
struct TypeTraits<Bytes> : public TypeTraitsBase {
  ...
  TVM_FFI_INLINE static std::string TypeSchema() {
    return std::string(R"({"type":")") + StaticTypeKey::kTVMFFIBytes + R"("})";
  }
};
...
struct TypeTraits<String> : public TypeTraitsBase {
  ...
  TVM_FFI_INLINE static std::string TypeSchema() {
    return std::string(R"({"type":")") + StaticTypeKey::kTVMFFIStr + R"("})";
  }
};
...
struct TypeTraits<TVMFFIByteArray*> : public TypeTraitsBase {
  ...
  TVM_FFI_INLINE static std::string TypeSchema() {
    return std::string(R"({"type":")") + StaticTypeKey::kTVMFFIByteArrayPtr + R"("})";
  }
};
