...
static_assert(std::is_constructible_v<ObjectPtr<TNumberObj>, ObjectPtr<TIntObj>>);
static_assert(!std::is_constructible_v<ObjectPtr<TIntObj>, ObjectPtr<TNumberObj>>);
static_assert(!std::is_constructible_v<ObjectPtr<TIntObj>, ObjectPtr<TFloatObj>>);
