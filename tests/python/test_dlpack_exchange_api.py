...
try:
    ...
    from tvm_ffi import libinfo  # noqa: F401
except ImportError:
    torch = None
    libinfo = None
...
def test_dlpack_exchange_api_version() -> None:
    ...
    void test_api_version(int64_t api_ptr_int) {
        ...
        // Check version (should be 1.x where x >= 1)
        TORCH_CHECK(api->header.version.major == 1, 
                    "Expected major version 1, got ", api->header.version.major);
        TORCH_CHECK(api->header.version.minor >= 1, 
                    "Expected minor version >= 1, got ", api->header.version.minor);
    }
    """
...
def test_managed_tensor_from_py_object() -> None:
    ...
    void test_from_py_object(at::Tensor tensor, int64_t api_ptr_int) {
        ...
        // Check version
        TORCH_CHECK(out_tensor->version.major == 1, "Expected major version 1");
        TORCH_CHECK(out_tensor->version.minor >= 0, "Invalid minor version");
