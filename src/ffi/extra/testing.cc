...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::ObjectDef<TestCxxClassBase>()
      .def_static("__init__",
                  [](int64_t v_i64, int32_t v_i32) -> Any {
                    return ObjectRef(ffi::make_object<TestCxxClassBase>(v_i64, v_i32));
                  })
  ...
  refl::ObjectDef<TestCxxClassDerived>()
      .def_static(
          "__init__",
          [](int64_t v_i64, int32_t v_i32, double v_f64, float v_f32) -> Any {
            return ObjectRef(ffi::make_object<TestCxxClassDerived>(v_i64, v_i32, v_f64, v_f32));
          })
  ...
  refl::ObjectDef<TestCxxClassDerivedDerived>()
      .def_static("__init__",
                  [](int64_t v_i64, int32_t v_i32, double v_f64, float v_f32, String v_str,
                     bool v_bool) -> Any {
                    return ObjectRef(ffi::make_object<TestCxxClassDerivedDerived>(
                        v_i64, v_i32, v_f64, v_f32, v_str, v_bool));
                  })
