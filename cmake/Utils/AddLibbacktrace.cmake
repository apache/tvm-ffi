...
function (_libbacktrace_compile)
    ...
    ExternalProject_Add(
        ...
        CONFIGURE_COMMAND
            "sh" "${_libbacktrace_source}/configure" "--prefix=${_libbacktrace_prefix}" --with-pic
            "CC=${_cmake_c_compiler}" "CPP=${_cmake_c_compiler} -E" "CFLAGS=${CMAKE_C_FLAGS}"
    ...
    set_target_properties(
        libbacktrace PROPERTIES IMPORTED_LOCATION ${_libbacktrace_prefix}/lib/libbacktrace.a
