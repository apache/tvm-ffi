...
for torch_minor in {4..9}
do
  uv venv /torch2$torch_minor && source /torch26/bin/activate
...
#   python python/tvm_ffi/utils/_build_optional_c_dlpack.py --build_dir ./addons/torch_c_dlpack_ext/torch_c_dlpack_ext
  echo "torch2$torch_minor" >> ./addons/torch_c_dlpack_ext/torch_c_dlpack_ext/libtorch_c_dlpack_addon.so
