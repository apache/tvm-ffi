...
// dlpack header must be included first
...
// Python module definition for torch.utils.cpp_extension
PYBIND11_MODULE(torch_c_dlpack_ext, m) {
  m.def("TorchDLPackExchangeAPIPtr", &TorchDLPackExchangeAPIPtr,
        "Get pointer to TorchDLPackExchangeAPI instance");
}
